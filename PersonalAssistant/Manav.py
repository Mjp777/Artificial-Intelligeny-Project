from tkinter import *	#initialize system modules
...
background, textColor = 'black', '#f5d3b3'
...
if __name__ == '__main__':
	...
	image1 = Image.open('extrafiles/images/home3.jpg')
	...
	#welcome label
	welcLbl = Label(root1, text='Welcome\n to \n \"AI SMART BUDDY - MANAV \"', font=('rockwell', 15), fg='#054f63', bg=background)
	welcLbl.pack(padx=10, pady=20)


	#add face
	loginStatus = Label(root1, text='LOCKED', font=('rockwell', 13), bg=background, fg='red')
	loginStatus.pack(pady=(40,20))	

	if os.path.exists('userData/trainer.yml')==False:
		loginStatus['text'] = 'Your Face is not registered'
		addFace = Button(root1, text='   Register Face   ', font=('times new roman', 18), bg='#018384', fg='white', relief=FLAT, command=lambda:raise_frame(root2))
	...
	image2 = Image.open('extrafiles/images/home6.jpg')
	...
	#name
	nameLbl = Label(userFrame2, text='Name:', font=('times new roman', 12,'bold'), fg='#000000', bg=background)
	nameLbl.place(x=10,y=10)
	nameField = Entry(userFrame2, bd=5, font=('Aerial', 10), width=25, relief=FLAT, bg='#ffffff')
	nameField.focus()
	nameField.place(x=80,y=10)

	genLbl = Label(userFrame2, text='Gender:', font=('times new roman', 12,'bold'), fg='#000000', bg=background)
	...
	genFemale.place(x=140,y=52)
	genOther = ttk.Radiobutton(userFrame2, text='Others', value=3, variable=r, style='Wild.TRadiobutton', takefocus=False)
	genOther.place(x=220,y=52)

	#agreement
	agr = IntVar()
	sc = ttk.Style()
	sc.configure('Wild.TCheckbutton', background=background, foreground='#000000', font=('halvetica',10), focuscolor=sc.configure(".")["background"])
	...
	#add face
	addBtn = Button(userFrame2, text='    Add Face    ', font=('anton', 12), bg='#b8b8b8', fg='black', command=Add_Face, relief=FLAT)
	...
	usernameLbl = Label(root4, text="Swapnil Kharose", font=('times new roman',15), bg=background, fg='#85AD4F')
