...
def voiceMedium():
	while True:
		...
		# if isContain(query, ENTRY_COMMANDS):
...
def main(text):
		...
		if 'your name' in text:
			speak('My name is, MAANAAV ',True,True)
			return
...
def showSingleImage(type, data=None):
	...
	if type=="weather":
		...
		Label(weather, text='pimpri chinchwad', font=('Arial Bold', 12), fg='white', bg='#3F48CC').place(x=50,y=160)
