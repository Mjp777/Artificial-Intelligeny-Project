...
class WEATHER:
	def __init__(self):
		#Currently in pune, its 26 with Haze
		self.tempValue = ''
		self.city = ''
		self.currCondition = ''
		self.speakResult = ''
	...
	def weather(self):
		...
		# self.speakResult = "Currently in " + self.city + ", its " + self.tempValue + " degree celcius " + self.currCondition
		self.speakResult = "Currently in pimpri chinchwad" + ", its " + self.tempValue + " degree celcius " + self.currCondition
		# self.speakResult = "Currently in Pimpri chinchwad, its " + self.tempValue + " degree " + self.currCondition
...
def sendWhatsapp(phone_no='',message=''):
	...
	# subprocess.Popen(r'C:\Users\Dell\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\WhatsApp\whatsapp.exe'+phone_no+'&text='+message)
...
def email(rec_email=None, text="Hello, It's MANAV here...", sub='MANAV'):
	# if '@gmail.com' not in rec_email:
	# 	return
	# s = smtplib.SMTP('smtp.gmail.com', 587)
	# s.starttls()
	# s.login("swapnilkharose2000@gmail.com", "nil&sk14") # eg, abc@gmail.com (email) and ****(pass)
	# message = 'Subject: {}\n\n{}'.format(sub, text)
	...
	sender_email = "swapnilkharose2000@gmail.com"
	password = "bhtasghutjjqvrqg"
	message = 'Subject: {}\n\n{}'.format(sub, text)
